...
public class StatisticsTracker extends AbstractTracker<BaseTrackerProperties, StatisticTimestamp> {
    ...
    private Map<Integer, List<Map.Entry<String, List<NodeData>>>> currentChunks = new HashMap<>();
    ...
    public State track(TrackingContext<StatisticTimestamp> trackingContext) {
        try {
            if (currentChunks.isEmpty()) {
                ...
                List<String> statistics = eduSharingService.getStatisticsNodeIds(trackFromTime, trackTsTo);
