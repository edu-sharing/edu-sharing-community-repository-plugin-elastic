...
import org.edu_sharing.elasticsearch.tracker.ShareInfoTracker;
import org.springframework.scheduling.annotation.Scheduled;

@Slf4j
@RequiredArgsConstructor
public class ShareTrackerJob implements MigrationCompletedAware {

    private final ShareInfoTracker shareInfoTracker;
